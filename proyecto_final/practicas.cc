...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: Diego de Luis Ballesteros");
   ...
   // asignacion en segundo plano de la función de animación
   glutIdleFunc( funcion_idle );

   // indicar las funciones que queremos que procesen los eventos del ratón
